...
def clear(list_of_df, start_year, stop_year):
    ...
    df_gdp = pd.melt(df_gdp, id_vars=['Country Name'])
    ...
    df_number_of_inhabitants = df_number_of_inhabitants.assign(result=df_number_of_inhabitants['Year'].isin(common_years['Year']).astype('int64'))
